    ...
    >
      <div className="mb-2 flex items-center justify-between">
        ...
        <button
          ...
          onClick={onClose}
          className="flex h-6 w-6 items-center justify-center rounded-md text-ink-400 hover:bg-white/[0.06] hover:text-ink-900"
        >
          <CloseIcon size={14} />
        </button>
      </div>
      ...
      <input
        ...
        placeholder="Find…"
        className="mb-2 w-full rounded-md border border-border bg-white/[0.04] px-2 py-1.5 text-sm text-ink-900 outline-none placeholder:text-ink-400 focus:border-brand-500/50"
      />
      <input
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex-1 rounded-md border border-border px-2 py-1.5 text-xs font-medium text-ink-700 hover:bg-white/[0.05] disabled:opacity-40"
        >
          Next
        </button>
        <button
        ...
        <button
          ...
          disabled={hits.length === 0}
          onClick={replaceAll}
          className="flex-1 rounded-md bg-brand-500 px-2 py-1.5 text-xs font-medium text-white hover:bg-brand-600 disabled:opacity-40"
        >
          Replace all
        </button>
      </div>
